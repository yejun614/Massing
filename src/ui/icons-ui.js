...
export const UI_ICONS = {
  ...
  chevronLeft: wrap('<path d="M10 3.4 5.4 8l4.6 4.6"/>'),
  chevronRight: wrap('<path d="m6 3.4 4.6 4.6L6 12.6"/>'),
  ...
  download: wrap('<path d="M8 1.8v8.4"/><path d="M4.6 7 8 10.4 11.4 7"/><path d="M2.6 11.4v1.4a1.2 1.2 0 0 0 1.2 1.2h8.4a1.2 1.2 0 0 0 1.2-1.2v-1.4"/>'),
