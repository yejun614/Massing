...
| Move | Drag. Dragging a zone moves everything inside it. Hold `Alt` to follow one grid axis at a time — most useful in 3D, where the axes run diagonally across the screen |
